...
> 本教程所有示例与实战，默认运行在 **Python + Jupyter Notebook** 环境中
...
- 一次 LLM 调用包含哪些核心要素
  （messages / context / parameters）
- 模型输出的本质
- 为什么“看起来一次回答”，实际上是逐 token 生成
...
- 整合 langchain 和 gradio，实现一个能对话的聊天 Agent

### **Day 11 ｜流式输出”**

#### 学习内容

- Streaming 在 LangChain 中的实现方式
- Gradio 如何边生成边更新 UI
...
### **Day 47 ｜ langchain 上下文实战**

#### 学习内容

- 学习基于 langchain 实现上下文功能
